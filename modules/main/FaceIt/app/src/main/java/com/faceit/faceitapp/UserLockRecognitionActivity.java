...
public class UserLockRecognitionActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    /*private void showLabelsDialog() {
        ...
        if (!uniqueLabelsSet.isEmpty()) { // Make sure that there are any labels
            ...
            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(UserLockRecognitionActivity.this, android.R.layout.simple_list_item_1, uniqueLabels) {
                @Override
            ...
            ListView mListView = new ListView(UserLockRecognitionActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        distanceThreshold = (float) 0.18; // Get initial value
